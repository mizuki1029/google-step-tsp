...
public class tsp_ga_5 {
	final static int N = 5;
	final static int M = 10; //first choice the number of random routes
	final static double coordinates[][] = new double[N][2];//the coordinates(x, y)
	final static int parent = 4; //the number of parent routes
	...
	final static int mutation = 3; //the number of mutation
	...
	static void sortRoute(double distances[], int left, int right) {
        ...
        sortRoute(distances, left, r);  // ピボットより左側をクイックソート
        sortRoute(distances, l, right); // ピボットより右側をクイックソート
    }
	...
	/*11. make multiple combining parent routes */
